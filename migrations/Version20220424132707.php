 ...
 */
final class Version20220424132707 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE destination ADD CONSTRAINT FK_3EC63EAA298246F6 FOREIGN KEY (continents_id) REFERENCES continent (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
