 ...
 */
final class Version20220408064257 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE destination ADD CONSTRAINT FK_3EC63EAA7E59064E FOREIGN KEY (group_continent_id) REFERENCES continent (id)');
